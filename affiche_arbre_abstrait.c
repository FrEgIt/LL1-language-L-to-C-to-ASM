...
void affiche_opExp(n_exp *n)
{
  ...
  else if(n->u.opExp_.op == modulo) affiche_texte("modulo", trace_abs);
  else if(n->u.opExp_.op == egal) affiche_texte("egal", trace_abs);
  else if(n->u.opExp_.op == diff) affiche_texte("diff", trace_abs);
  else if(n->u.opExp_.op == sup) affiche_texte("sup", trace_abs);
  else if(n->u.opExp_.op == supeg) affiche_texte("supeg", trace_abs);
